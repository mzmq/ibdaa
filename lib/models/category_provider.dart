...
class CategoryProvider with ChangeNotifier {
  final List<CategoryItem> _item = [
    CategoryItem(id: 'c1', Title: 'المواسير والتمديد الصحي', imgUrl: 'assets/images/cardimage.jpg') ,
    CategoryItem(id: 'c2', Title: 'الكهربائي', imgUrl: 'assets/images/cardimage.jpg') ,
