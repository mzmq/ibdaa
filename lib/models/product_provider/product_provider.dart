...
class ProductProviderCart with ChangeNotifier {
  final List<Product> _items = [
    Product(
        id: 'p1',
        title: 'المنتج الاول',
        description: 'this is product_screen 1 good product_screen',
        price: 50.0,
        imageUrl:
    ...
    Product(
        id: 'p2',
        title: 'Product2',
        description: 'this is product_screen 2 good product_screen',
        price: 9.99,
        imageUrl:
    ...
    Product(
        id: 'p3',
        title: 'Product3',
        description: 'this is product_screen 3 good product_screen',
        price: 9.99,
        imageUrl:
    ...
    Product(
        id: 'p4',
        title: 'Product4',
        description: 'this is product_screen 4 good product_screen',
        price: 9.99,
        imageUrl:
